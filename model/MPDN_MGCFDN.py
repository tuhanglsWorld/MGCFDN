...
from backbones.MPDN import MPDN
...
class MultiGranularityConsistencyForgeryDetectionNet(nn.Module):
    def __init__(self, feature_channels=408, inner_channels=256, out_channel=1, dropout=0.6, topk=40):
        super(MultiGranularityConsistencyForgeryDetectionNet, self).__init__()
        self.visual_feature_extractor = MPDN()
